...
method get*(this: Target, line: EditLine, n: int): int {.base.} =
  if this.c.len == 1:
    case this.c
    of "0":
      return 0
    ...
    of "$", "]":
      return line.line.len-1
    of "l":
      return min(line.cursor+n, line.line.len-1)
    of "h":
      return max(line.cursor-n, 0)
    of "W":
      var i = 0
...
method getForRange*(this: Target, line: EditLine, n: int): int {.base.} =
  if this.c.len == 1:
    case $this.c[0]
    of "E":
      return get(this, line, n) + 1
    else:
      let p = get(this, line, n)
      if p == 0:
        return p
